                  ...
                  <hr style="color:#FFFFFF"/>
               	  <div align="center">
                  	<table cellpadding="0" width="100%" cellspacing="0" style="color:#3c6084;border:2px #3c6084 solid;">
                        <tr>
                        <td align="center" width="1%" style="padding-bottom:5px;font-family:Wingdings; font-size:40px; color:#FFFFFF">J</td>
                        <td align="left" style="padding-bottom:5px;color:#FFFFFF"><bean:write name="info" /></td>
                        </tr>
                        <tr>
