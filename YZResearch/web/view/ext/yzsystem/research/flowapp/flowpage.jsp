...
<html>
	...
	<script type="text/javascript" src="<%=context%>/view/ext/yzsystem/research/flowapp/userComboBox.js"></script>
	<script type="text/javascript" src="<%=context%>/view/ext/yzsystem/research/flowapp/flowedit.js"></script>
	<script type="text/javascript" src="<%=context%>/view/ext/yzsystem/research/flowapp/flowpage.js"></script>
</head>
<script type="text/javascript">
var context = "<%=context%>";
var submmitUrl= "/yzsystem/research/appflow.do?method=submitAppFlows&rsCode=RCH_APPFLOW_PAGE_SUBMIT";
</script>
<body>
<div id="center"></div>
</body>
