...
<head>
	...
	<script type="text/javascript" src="<%=context%>/view/ext/yzsystem/research/passenger/passengerlist.js"></script>
...
var context = "<%=context%>";
var submmitUrl= "/yzsystem/research/passenger.do?method=getPassengers&rsCode=RCH_PASSENGER_PAGE_INSERT";
</script>
<div id="center"></div>
</body>
</html>