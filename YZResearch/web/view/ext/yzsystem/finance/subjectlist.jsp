...
<head>
	...
	<script type="text/javascript" src="<%=context%>/view/ext/yzsystem/finance/subjectEdit.js"></script>
	<script type="text/javascript" src="<%=context%>/view/ext/yzsystem/finance/subjectlist.js"></script>
<title></title>
</head>
<body>
...
var submmitUrl= "/yzsystem/finance/subjectmgr.do?method=insertSubject&rsCode=SUBJMGR_PAGE_INSERT";
</script>
<div id="center"></div>
</body>
</html>