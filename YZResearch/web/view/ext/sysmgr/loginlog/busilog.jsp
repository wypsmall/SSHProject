...
<html>
	...
	<script type="text/javascript" src="<%=context%>/ext3.0/ux/daterange.js"></script>
	...
	<script type="text/javascript" src="<%=context%>/view/ext/sysmgr/loginlog/busilog.js"></script>
</head>
